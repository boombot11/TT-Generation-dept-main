...
const executeExcelMacro = (filePath, macroName) => {
...
const uploadExcel = async (req, res) => {
    ...
    try {
        ...
        await executeExcelMacro(tempFilePath, macroName);
        console.log('Macro executed successfully');  // Debug print

        // Create a readable stream from the modified Excel file
        const fileStream = fs.createReadStream(tempFilePath, { highWaterMark: 64 * 1024 }); // 64 KB buffer size (adjust as needed)
